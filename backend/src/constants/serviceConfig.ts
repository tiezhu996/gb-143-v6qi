...
export const apiEndpoints = [
  ...
  'GET  /api/v1/admin/service-types/weights - 当前类型权重版本',
  'GET  /api/v1/admin/service-types/:type/versions - 类型权重历史版本',
  'PUT  /api/v1/admin/service-types/weights - 调整类型权重/停用(乐观锁)',
];
